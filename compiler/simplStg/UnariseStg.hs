...
unariseExpr us rho case_@(StgCase e bndr alt_ty alts) ty
  = let ret = StgCase (unariseExpr us1 rho e ty) bndr alt_ty' alts'
...
unariseExpr us rho (StgLetNoEscape bind e) ty
  = StgLetNoEscape (unariseBinding us1 rho bind) (unariseExpr us2 rho e ty)
  where
    (us1, us2) = splitUniqSupply us
